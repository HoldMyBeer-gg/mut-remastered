...
**Domain:** Modern MUD (Multi-User Dungeon) — Rust server + dual TUI clients + web armory
**Researched:** 2026-03-23
**Confidence:** HIGH (core stack), MEDIUM (web frontend, procedural gen), HIGH (auth, serialization)
...
npm create svelte@latest web-client
cd web-client
npm install @xterm/xterm @xterm/addon-attach @xterm/addon-fit @xterm/addon-web-links
...
**Server architecture — single process (recommended for v1):**
...
**Server architecture — multi-process (defer to later milestone):**
...
*Stack research for: MUT Remastered — Rust MUD with dual TUI clients and web armory*
*Researched: 2026-03-23*
